...
public strictfp class WidgetWrapper
  ...
  WidgetWrapper(Widget widget, WidgetPanel interfacePanel) {
    ...
    topBar = new WidgetWrapperEdge(WidgetWrapperEdge.Type.TOP, BORDER_E, BORDER_W, verticallyResizable);
    leftBar = new WidgetWrapperEdge(WidgetWrapperEdge.Type.SIDE, 0, 0, horizontallyResizable);
    rightBar = new WidgetWrapperEdge(WidgetWrapperEdge.Type.SIDE, 0, 0, horizontallyResizable);
    bottomBar = new WidgetWrapperEdge(WidgetWrapperEdge.Type.BOTTOM, BORDER_E, BORDER_W, verticallyResizable);
  ...
  private final WidgetWrapperEdge topBar;
  private final WidgetWrapperEdge leftBar;
  private final WidgetWrapperEdge rightBar;
  private final WidgetWrapperEdge bottomBar;
